...
C:\Windows\System32\FC tests\output1.idx tests\correctYO.idx 
...
C:\Windows\System32\FC tests\output2.idx tests\correctDashesAndOpostrophesInsideLexems.idx 
IF ERRORLEVEL 1 GOTO err 
...
C:\Windows\System32\FC tests\output3.idx tests\correctDashesAndOpostrophesOnLexemEdges.idx 
IF ERRORLEVEL 1 GOTO err 
...
C:\Windows\System32\FC tests\output4.idx tests\correctLexemCounting.idx 
IF ERRORLEVEL 1 GOTO err 
...
C:\Windows\System32\FC tests\output5.idx tests\correctLowerRegister.idx 
IF ERRORLEVEL 1 GOTO err 
...
C:\Windows\System32\FC tests\output6.idx tests\correctSingleDashesAndOpostrophes.idx 
IF ERRORLEVEL 1 GOTO err 
